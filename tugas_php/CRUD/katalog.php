...
<body>
    ...
    <div class="my-2 ms-5">
        <a class="btn btn-primary" role="button" href="add_katalog.php">Add New Katalog</a>
    </div>
    ...
    <?php  
        while($katalog_data = mysqli_fetch_array($katalog)) {         
            ...
            echo "<td><a class='btn btn-primary' href='edit_katalog.php?id_katalog=$katalog_data[id_katalog]'>Edit</a> | <a class='btn btn-danger' href='delete.php?id_katalog=$katalog_data[id_katalog]&page=katalog'>Delete</a></td></tr>";                      
        }
    ?>
    </table>
</body>
